...
var $author$project$Pokertool$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $elm$core$Maybe$Nothing = {$: 'Nothing'};
var $author$project$Pokertool$UrlChanged = function (a) {
...
var $author$project$Pokertool$generateUserUUID = A2($elm$random$Random$generate, $author$project$Pokertool$UuidGenerated, $TSFoster$elm_uuid$UUID$generator);
...
var $author$project$Room$Room = F4(
	function (user, id, revealed, members) {
		return {id: id, members: members, revealed: revealed, user: user};
	});
...
var $author$project$Room$VoteInfo = F4(
	function (id, name, vote, ping) {
		return {id: id, name: name, ping: ping, vote: vote};
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Room$memberInfoDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Room$VoteInfo,
	A2($elm$json$Json$Decode$field, 'Id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'Name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'Vote', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'Ping', $elm$json$Json$Decode$int));
var $author$project$Room$User = F2(
	function (id, name) {
		return {id: id, name: name};
	});
var $author$project$Room$UserVote = F3(
	function (user, vote, ping) {
		return {ping: ping, user: user, vote: vote};
	});
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $author$project$Room$toMember = function (m) {
	return A3(
		$author$project$Room$UserVote,
		A2($author$project$Room$User, m.a, m.b.name),
		m.b.vote,
		m.b.ping);
};
var $author$project$Room$toMembers = $elm$core$List$map($author$project$Room$toMember);
var $author$project$Room$membersDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Room$toMembers,
	$elm$json$Json$Decode$keyValuePairs($author$project$Room$memberInfoDecoder));
var $author$project$Room$roomDecoder = function (a) {
	return A4(
...
var $author$project$Pokertool$init = F3(
	function (flags, url, key) {
		var _v0 = flags.roomId;
		if (_v0.$ === 'Just') {
			var roomId = _v0.a;
			var _v1 = flags.user;
			if (_v1.$ === 'Just') {
...
var $author$project$Pokertool$Ping = function (a) {
	return {$: 'Ping', a: a};
};
...
var $author$project$Pokertool$loadUserPort = _Platform_incomingPort('loadUserPort', $elm$json$Json$Decode$string);
var $author$project$Pokertool$pingTimeSeconds = 5;
var $author$project$Pokertool$LoggedInUser = function (a) {
	return {$: 'LoggedInUser', a: a};
};
var $author$project$Pokertool$userDecoder = function (value) {
	var _v0 = A2(
		$elm$json$Json$Decode$decodeString,
		A3(
			$elm$json$Json$Decode$map2,
			$author$project$Room$User,
			A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string)),
		value);
	if (_v0.$ === 'Ok') {
		var user = _v0.a;
		return $author$project$Pokertool$LoggedInUser(
			$elm$core$Maybe$Just(user));
	} else {
		return $author$project$Pokertool$LoggedInUser($elm$core$Maybe$Nothing);
	}
};
var $author$project$Pokertool$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Pokertool$loadUserPort($author$project$Pokertool$userDecoder),
				A2($elm$time$Time$every, $author$project$Pokertool$pingTimeSeconds * 1000, $author$project$Pokertool$Ping)
			]));
};
...
var $author$project$Pokertool$storeUserPort = _Platform_outgoingPort(
	'storeUserPort',
	function ($) {
...
var $author$project$Pokertool$update = F2(
	function (msg, model) {
		if (model.$ === 'LoadingRoomState') {
			var loadingRoom = model.a;
			switch (msg.$) {
				case 'LoggedInUser':
					var user = msg.a;
					if (user.$ === 'Just') {
						var u = user.a;
						var _v3 = loadingRoom.roomId;
						if (_v3.$ === 'Just') {
							var roomId = _v3.a;
							return _Utils_Tuple2(
								model,
							...
							return _Utils_Tuple2(
								$author$project$Pokertool$LoadingRoomState(
									_Utils_update(
										loadingRoom,
										{user: user, userUuid: u.id})),
								$elm$core$Platform$Cmd$none);
						}
					} else {
						return _Utils_Tuple2(model, $author$project$Pokertool$generateUserUUID);
					}
				case 'UuidGenerated':
					var uuid = msg.a;
					return _Utils_Tuple2(
						$author$project$Pokertool$LoadingRoomState(
							_Utils_update(
								loadingRoom,
								{
									userUuid: $TSFoster$elm_uuid$UUID$toString(uuid)
								})),
						$elm$core$Platform$Cmd$none);
				case 'CreateRoom':
					var _v4 = loadingRoom.user;
					if (_v4.$ === 'Just') {
						var user = _v4.a;
						return _Utils_Tuple2(
							model,
				...
				case 'InputRoomId':
					...
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'Login':
					var user = A2($author$project$Room$User, loadingRoom.userUuid, loadingRoom.inputUser);
					return _Utils_Tuple2(
						$author$project$Pokertool$LoadingRoomState(
							_Utils_update(
								loadingRoom,
						...
						$author$project$Pokertool$storeUserPort(user));
				case 'LinkClicked':
...
var $author$project$Pokertool$CreateRoom = {$: 'CreateRoom'};
var $author$project$Pokertool$InputRoomId = function (a) {
	return {$: 'InputRoomId', a: a};
};
var $author$project$Pokertool$InputUser = function (a) {
	return {$: 'InputUser', a: a};
};
var $author$project$Pokertool$JoinRoom = {$: 'JoinRoom'};
var $author$project$Pokertool$Login = {$: 'Login'};
...
var $author$project$Views$button = F3(
	function (event, label, enabled) {
		return A2(
...
var $author$project$Views$centered = function (children) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Views$hint = function (t) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('form-text mt-0 mb-4 text-end')
			]),
		_List_fromArray(
			[
...
var $author$project$Views$textInput = F3(
	function (options, event, model) {
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$placeholder(options.placeholder),
					$elm$html$Html$Events$onInput(event),
					$elm$html$Html$Attributes$value(model)
				]),
			_List_Nil);
	});
var $author$project$Views$insertUserName = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Insert your name:')
						])),
					A3(
					$author$project$Views$textInput,
					{placeholder: ''},
					event,
					model)
				]));
...
var $author$project$Pokertool$isValidRoomId = function (name) {
	return 36 <= $elm$core$String$length(
		$elm$core$String$trim(name));
};
var $author$project$Pokertool$isValidUser = function (name) {
	return 3 <= $elm$core$String$length(
		$elm$core$String$trim(name));
};
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$Pokertool$askUser = function (model) {
	var _v0 = model.user;
	if (_v0.$ === 'Nothing') {
		var _v1 = model.roomId;
		if (_v1.$ === 'Just') {
			var roomId = _v1.a;
			return $author$project$Views$centered(
				_List_fromArray(
					[
						A2($author$project$Views$insertUserName, $author$project$Pokertool$InputUser, model.inputUser),
						A3($author$project$Views$button, $author$project$Pokertool$JoinRoom, 'Join', true)
					]));
		} else {
			return $author$project$Views$centered(
				_List_fromArray(
					[
						A2($author$project$Views$insertUserName, $author$project$Pokertool$InputUser, model.inputUser),
						$author$project$Views$hint('A valid user name must be at least 3 character long'),
						A3(
						$author$project$Views$button,
						$author$project$Pokertool$Login,
						'Login',
						$author$project$Pokertool$isValidUser(model.inputUser))
					]));
		}
	} else {
		var user = _v0.a;
		return $author$project$Views$centered(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($author$project$Views$button, $author$project$Pokertool$CreateRoom, 'Create a New room', true)
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-center mt-1 mb-1')
						]),
					_List_fromArray(
						[
					...
					A3(
					$author$project$Views$textInput,
					{placeholder: 'Paste a valid Room Id'},
					$author$project$Pokertool$InputRoomId,
					model.inputRoomId),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							A3(
							$author$project$Views$button,
							$author$project$Pokertool$CreateRoom,
							'Join an Existing One',
							$author$project$Pokertool$isValidRoomId(model.inputRoomId))
						]))
				]));
	}
};
var $author$project$Views$body = function (el) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('row justify-content-center mt-5')
			]),
		_List_fromArray(
			[el]));
};
var $author$project$Views$footer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Views$header = function (el) {
	return A2(
		$elm$html$Html$nav,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('navbar bg-body-tertiary')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('navbar-brand text-center')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('poker estimation tool')
							]))
					])),
				el
			]));
};
var $author$project$Views$page = F2(
	function (headerEl, bodyEl) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Views$header(headerEl),
					$author$project$Views$body(bodyEl),
					$author$project$Views$footer
				]));
	});
...
var $author$project$Views$linkButton = F3(
	function (label, url, enabled) {
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
...
var $author$project$Pokertool$viewLogoutLink = F2(
	function (user, roomId) {
		if (user.$ === 'Nothing') {
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Hello ' + (u.name + ', ')),
						A3($author$project$Views$linkButton, 'logout', '/logout', true)
					]));
		}
	});
var $author$project$Views$centeredLarge = function (children) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Pokertool$currentUserVote = function (model) {
	return A2(
		$elm$core$Maybe$withDefault,
		A3(
			$author$project$Room$UserVote,
			A2($author$project$Room$User, '', ''),
			0,
			0),
		$elm$core$List$head(
			A2(
				...
				function (u) {
					return _Utils_eq(u.user.id, model.user.id);
				},
				model.room.members))).vote;
};
var $author$project$Pokertool$Reset = {$: 'Reset'};
var $author$project$Pokertool$Reveal = {$: 'Reveal'};
...
var $author$project$Pokertool$majorityOf = function (votes) {
	return A2(
		$elm$core$Maybe$withDefault,
		_Utils_Tuple2(0, 0),
		$elm$core$List$head(
...
var $author$project$Pokertool$meanOf = function (votes) {
	var sum = $elm$core$List$sum(
		A2(
			...
			votes));
	return sum / $elm$core$List$length(votes);
};
...
var $author$project$Pokertool$viewResults = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('list-group-item d-flex justify-content-between align-items-start fs-5')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Majority of: ')
											]))
									])),
								$elm$html$Html$text(
								$elm$core$String$fromInt(
									$author$project$Pokertool$majorityOf(model.room.members)))
							])),
						A2(
						$elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								A2(
									...
									$author$project$Pokertool$meanOf(model.room.members)))
							]))
					]))
			]));
};
var $author$project$Pokertool$viewRevealButton = function (model) {
	return model.room.revealed ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('mt-3')
		...
		_List_fromArray(
			[
				$author$project$Pokertool$viewResults(model),
				A3($author$project$Views$button, $author$project$Pokertool$Reset, 'Reset', true)
			])) : A2(
		$elm$html$Html$p,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3($author$project$Views$button, $author$project$Pokertool$Reveal, 'Reveal', true)
			]));
};
var $author$project$Pokertool$viewRoomLink = function (room) {
	return A2(
		$elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Share Room Link: '),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('font-monospace'),
						$elm$html$Html$Attributes$href('?id=' + room.id)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(room.id)
					]))
			]));
};
var $author$project$Pokertool$sortByName = function (members) {
	return A2(
		$elm$core$List$sortBy,
		function (t) {
			return t.user.name;
...
var $author$project$Pokertool$sortByVote = function (members) {
	return A2(
		$elm$core$List$sortBy,
		function (t) {
			return -t.vote;
...
var $author$project$Pokertool$viewUserStatus = F2(
	function (lastPing, user) {
		var disconnected = _Utils_cmp(lastPing - user.ping, $author$project$Pokertool$pingTimeSeconds * 2) > 0;
		return disconnected ? A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('bi bi-lightning-charge-fill text-danger')
						]),
					_List_Nil)
				])) : A2($elm$html$Html$span, _List_Nil, _List_Nil);
	});
var $author$project$Pokertool$viewVote = F2(
	function (revealed, vote) {
		return revealed ? $elm$html$Html$text(
			$elm$core$String$fromInt(vote)) : ((vote > 0) ? A2(
			$elm$html$Html$i,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bi bi-check-lg text-success')
				]),
			_List_Nil) : A2(
			$elm$html$Html$i,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bi bi-dash')
				]),
			_List_Nil));
	});
var $author$project$Pokertool$viewUserVote = F2(
	function (model, userVote) {
		var currentUserClass = _Utils_eq(model.user.id, userVote.user.id) ? 'fw-bold text-black' : 'text-secondary';
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class(currentUserClass)
								]),
							_List_fromArray(
								[
									A2($author$project$Pokertool$viewUserStatus, model.lastPing, userVote),
									$elm$html$Html$text(userVote.user.name)
								]))
						])),
					A2($author$project$Pokertool$viewVote, model.room.revealed, userVote.vote)
				]));
	});
var $author$project$Pokertool$viewUserVotes = function (model) {
	var sortBy = model.room.revealed ? $author$project$Pokertool$sortByVote : $author$project$Pokertool$sortByName;
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('list-group list-group-flush mt-5')
			]),
		A2(
			$elm$core$List$map,
			$author$project$Pokertool$viewUserVote(model),
			sortBy(model.room.members)));
};
var $author$project$Pokertool$CastVote = function (a) {
	return {$: 'CastVote', a: a};
};
var $author$project$Pokertool$valueButton = F2(
	function (userVote, vote) {
		var className = _Utils_eq(userVote, vote) ? 'btn-info' : 'btn-outline-info';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('button'),
							$elm$html$Html$Attributes$class('btn ' + (className + ' shadow w-100 fs-1')),
							$elm$html$Html$Events$onClick(
							$author$project$Pokertool$CastVote(vote))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(vote))
						]))
				]));
	});
var $author$project$Pokertool$viewValueBar = F2(
	function (values, userVote) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				$author$project$Pokertool$valueButton(userVote),
				values));
	});
var $author$project$Pokertool$viewRoom = function (model) {
	return $author$project$Views$centeredLarge(
		_List_fromArray(
			[
				$author$project$Pokertool$viewRoomLink(model.room),
				A2(
				$author$project$Pokertool$viewValueBar,
				model.values,
				$author$project$Pokertool$currentUserVote(model)),
				$author$project$Pokertool$viewUserVotes(model),
				$author$project$Pokertool$viewRevealButton(model)
			]));
};
var $author$project$Pokertool$mainView = function (model) {
	if (model.$ === 'LoadingRoomState') {
		var loadingRoom = model.a;
		return A2(
			$author$project$Views$page,
			A2($author$project$Pokertool$viewLogoutLink, loadingRoom.user, loadingRoom.roomId),
			$author$project$Pokertool$askUser(loadingRoom));
	} else {
		var loadedRoom = model.a;
		return A2(
			$author$project$Views$page,
			A2(
				$author$project$Pokertool$viewLogoutLink,
				$elm$core$Maybe$Just(loadedRoom.user),
				$elm$core$Maybe$Just(loadedRoom.room.id)),
			$author$project$Pokertool$viewRoom(loadedRoom));
	}
};
var $author$project$Pokertool$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Pokertool$mainView(model)
			]),
		title: 'Poker Tool'
	};
};
var $author$project$Pokertool$main = $elm$browser$Browser$application(
	{init: $author$project$Pokertool$init, onUrlChange: $author$project$Pokertool$UrlChanged, onUrlRequest: $author$project$Pokertool$LinkClicked, subscriptions: $author$project$Pokertool$subscriptions, update: $author$project$Pokertool$update, view: $author$project$Pokertool$view});
_Platform_export({'Pokertool':{'init':$author$project$Pokertool$main(
	A2(
